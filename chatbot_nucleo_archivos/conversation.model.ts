...
export interface Conversation {
    ...
    createdAt: number;
    updatedAt: number;
     // NUEVO: Información temporal del usuario durante la conversación
    tempUserInfo?: TempUserInfo;
  }

  export interface TempUserInfo {
    whatsappNumber?: string;
    lastEmailPrompt?: number; 
  }
...
export interface Feedback {
  ...
  export interface ContextResult {
    ...
    systemInstructions: string;
      activeIntegrations?: IntegrationInfo[];
    // NUEVO: Información del usuario desde WhatsApp
    userContext?: UserContext;
  }

  // NUEVO: Contexto de usuario extraído de WhatsApp
