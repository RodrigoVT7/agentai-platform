...
import { AgentDetailsHandler } from "../../shared/handlers/agents/agentDetailsHandler";
import { createLogger } from "../../shared/utils/logger";
import { toAppError } from "../../shared/utils/error.utils";
import { JwtService } from "../../shared/utils/jwt.service";

export async function AgentDetails(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
  ...
  try {
    ...
    const handler = new AgentDetailsHandler(logger);
    ...
    logger.error(`Error al obtener detalles del agente:`, error);
