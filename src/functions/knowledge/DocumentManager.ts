    ...
    switch (request.method) {
      case "GET":
        if (documentId) {
          ...
          return await handler.listDocuments(knowledgeBaseId, userId, {
            limit,
            skip,
            status,
          });
          ...
          return {
            status: 400,
            jsonBody: {
              error: "Se requiere knowledgeBaseId para listar documentos",
            },
          };
        }
        ...
        try {
          ...
          try {
            ...
            return {
              ...
              jsonBody: {
                error:
                  "Error al parsear JSON. Asegúrate de enviar un JSON válido",
                details:
