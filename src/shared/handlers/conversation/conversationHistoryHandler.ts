...
export class ConversationHistoryHandler {
  ...
  private async verifyConversationAccess(
    ...
    try {
      ...
      this.logger.error(
        `Error al verificar acceso a conversación ${conversationId}:`,
        error
      );
      return false;
    }
  ...
  private async getConversationDetails(conversationId: string): Promise<any> {
    try {
      ...
      this.logger.error(
        `Error al obtener detalles de conversación ${conversationId}:`,
        error
      );
      return null;
    }
  ...
  private async getConversationMessages(
    ...
    try {
      ...
      this.logger.error(
        `Error al obtener mensajes de conversación ${conversationId}:`,
        error
      );
      return [];
    }
